  ...
  const handleSubmit = (e) => {
    ...
    if (formData.cpassword !== formData.password) {
      ...
      validationErrors.cpassword =
        "Confirm Password is not matching with the passowrd";
    }
    ...
    <body style={{ height: "100%", width: "100%" }}>
      ...
      <div className="header">
        ...
        <p className="subtitle">
          Unlock Best prices and become an insider for our exclusive <br />
          launches & offers. Complete your profile and get ₹250 worth
          <br /> of xCLusive Points.
        </p>
      </div>
      <p id="use">USING</p>
