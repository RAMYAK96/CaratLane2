...
const Login = () => {
  ...
  return (
    <body>
      ...
      >
        Login to unlock best prices and become an insider <br /> for our
        exclusive launches & offers. Complete your <br /> profile and get ₹250
        worth of xCLusive Points.
      </p>
      ...
      <div
        style={{ display: "flex", marginLeft: "608px", marginBottom: "80px" }}
      >
